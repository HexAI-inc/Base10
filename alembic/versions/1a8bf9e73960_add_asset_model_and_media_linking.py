...
def upgrade() -> None:
    ...
    with op.batch_alter_table('questions', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('options_json', sa.Text(), nullable=False))
        batch_op.add_column(sa.Column('correct_index', sa.Integer(), nullable=False))
        ...
        #        type_=sa.Enum('MATHEMATICS', 'ENGLISH', 'PHYSICS', 'CHEMISTRY', 'BIOLOGY', 'ECONOMICS', 'GEOGRAPHY', 'GOVERNMENT', 'CIVIC_EDUCATION', 'FINANCIAL_ACCOUNTING', name='subject'),
    ...
    with op.batch_alter_table('student_profiles', schema=None) as batch_op:
        ...
        #        nullable=True,
        #        existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
        # batch_op.drop_constraint('uq_classroom_student', type_='unique')
        ...
        # batch_op.create_foreign_key('fk_student_profiles_teacher_id', 'users', ['teacher_id'], ['id'])
        # batch_op.create_foreign_key('fk_student_profiles_classroom_id', 'classrooms', ['classroom_id'], ['id'])
        # batch_op.create_foreign_key('fk_student_profiles_student_id', 'users', ['student_id'], ['id'])
        pass
    ...
    with op.batch_alter_table('teacher_messages', schema=None) as batch_op:
        ...
        # batch_op.create_foreign_key('fk_teacher_messages_classroom_id', 'classrooms', ['classroom_id'], ['id'])
        # batch_op.create_foreign_key('fk_teacher_messages_teacher_id', 'users', ['teacher_id'], ['id'])
        # batch_op.create_foreign_key('fk_teacher_messages_student_id', 'users', ['student_id'], ['id'])
        pass
