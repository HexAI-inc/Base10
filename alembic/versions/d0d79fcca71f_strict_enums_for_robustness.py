...
def upgrade() -> None:
    ...
    with op.batch_alter_table('assignments', schema=None) as batch_op:
        ...
        batch_op.alter_column('topic_filter', existing_type=sa.VARCHAR(length=100), type_=sa.Enum('Algebra', 'Geometry', 'Trigonometry', 'Statistics', 'Probability', 'Calculus', 'Number Bases', 'Sets', 'Logarithms', 'Fractions', 'Decimals', 'Ratios', 'Percentages', 'Indices', 'Surds', 'Grammar', 'Comprehension', 'Vocabulary', 'Oral English', 'Writing', 'Mechanics', 'Thermal Physics', 'Waves', 'Electricity', 'Magnetism', 'Atomic Physics', 'Optics', 'Atomic Structure', 'Chemical Bonding', 'Stoichiometry', 'States of Matter', 'Periodic Table', 'Organic Chemistry', 'Electrochemistry', 'Cell Biology', 'Genetics', 'Ecology', 'Physiology', 'Evolution', 'Classification', 'General', 'Other', name='topic'), postgresql_using='"topic_filter"::topic',
               existing_nullable=True)
    ...
    with op.batch_alter_table('questions', schema=None) as batch_op:
        batch_op.alter_column('subject', existing_type=sa.VARCHAR(length=100), type_=sa.Enum('Mathematics', 'English Language', 'Physics', 'Chemistry', 'Biology', 'Economics', 'Geography', 'Government', 'Civic Education', 'Financial Accounting', 'Agricultural Science', 'Commerce', 'Literature in English', 'Data Science', name='subject'), postgresql_using='subject::subject',
               existing_nullable=False)
        batch_op.alter_column('topic', existing_type=sa.VARCHAR(length=100), type_=sa.Enum('Algebra', 'Geometry', 'Trigonometry', 'Statistics', 'Probability', 'Calculus', 'Number Bases', 'Sets', 'Logarithms', 'Fractions', 'Decimals', 'Ratios', 'Percentages', 'Indices', 'Surds', 'Grammar', 'Comprehension', 'Vocabulary', 'Oral English', 'Writing', 'Mechanics', 'Thermal Physics', 'Waves', 'Electricity', 'Magnetism', 'Atomic Physics', 'Optics', 'Atomic Structure', 'Chemical Bonding', 'Stoichiometry', 'States of Matter', 'Periodic Table', 'Organic Chemistry', 'Electrochemistry', 'Cell Biology', 'Genetics', 'Ecology', 'Physiology', 'Evolution', 'Classification', 'General', 'Other', name='topic'), postgresql_using='"topic"::topic',
               nullable=False)
        batch_op.alter_column('difficulty', existing_type=sa.VARCHAR(length=20), type_=sa.Enum('easy', 'medium', 'hard', name='difficultylevel'), postgresql_using='difficulty::difficultylevel',
               existing_nullable=True)
