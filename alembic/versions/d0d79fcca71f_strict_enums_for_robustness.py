...
def upgrade() -> None:
    ...
    if op.get_bind().dialect.name == 'postgresql':
        op.execute("DO $$ BEGIN CREATE TYPE subject AS ENUM ('MATHEMATICS', 'ENGLISH', 'PHYSICS', 'CHEMISTRY', 'BIOLOGY', 'ECONOMICS', 'GEOGRAPHY', 'GOVERNMENT', 'CIVIC_EDUCATION', 'FINANCIAL_ACCOUNTING', 'AGRICULTURAL_SCIENCE', 'COMMERCE', 'LITERATURE_IN_ENGLISH'); EXCEPTION WHEN duplicate_object THEN null; END $$;")
        op.execute("DO $$ BEGIN CREATE TYPE topic AS ENUM ('ALGEBRA', 'GEOMETRY', 'TRIGONOMETRY', 'STATISTICS', 'PROBABILITY', 'CALCULUS', 'NUMBER_BASES', 'SETS', 'LOGARITHMS', 'GRAMMAR', 'COMPREHENSION', 'VOCABULARY', 'ORAL_ENGLISH', 'WRITING', 'MECHANICS', 'THERMAL_PHYSICS', 'WAVES', 'ELECTRICITY', 'MAGNETISM', 'ATOMIC_PHYSICS', 'OPTICS', 'ATOMIC_STRUCTURE', 'CHEMICAL_BONDING', 'STOICHIOMETRY', 'STATES_OF_MATTER', 'PERIODIC_TABLE', 'ORGANIC_CHEMISTRY', 'ELECTROCHEMISTRY', 'CELL_BIOLOGY', 'GENETICS', 'ECOLOGY', 'PHYSIOLOGY', 'EVOLUTION', 'CLASSIFICATION', 'GENERAL', 'OTHER'); EXCEPTION WHEN duplicate_object THEN null; END $$;")
